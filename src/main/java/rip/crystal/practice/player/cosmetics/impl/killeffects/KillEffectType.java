...
public enum KillEffectType
{
    ...
    CLOUD("Cloud", "CLOUD", Material.WOOL, 500, location -> ParticleEffect.CLOUD.display(0.0f, 0.0f, 0.0f, 0.1f, 100, location, 20.0)),
    ...
    COOKIE("Cookie", "COOKIE", Material.COOKIE, 500, location -> ParticleEffect.ITEM_CRACK.display(new ParticleEffect.ItemData(Material.COOKIE, (byte)0), 0.7f, 0.7f, 0.7f, 0.1f, 35, location, 20.0)),
    ...
    TNT("TNT", "TNT", Material.TNT, 500, location -> ParticleEffect.EXPLOSION_LARGE.display(0.5f, 0.5f, 0.5f, 1.0f, 12, location, 20.0)),
    ...
    FLAME("Flame", "FLAME", Material.FLINT_AND_STEEL, 500, location -> ParticleEffect.FLAME.display(0.2f, 0.2f, 0.2f, 0.1f, 10, location, 20.0)),
    ...
    HAPPY("Happy", "HAPPY", Material.EMERALD_ORE, 500, location -> ParticleEffect.VILLAGER_HAPPY.display(0.5f, 0.5f, 0.5f, 0.01f, 100, location, 20.0)),
    HEART("Heart", "HEART", Material.REDSTONE_BLOCK, 500, location -> ParticleEffect.HEART.display(0.4f, 0.4f, 0.4f, 0.1f, 10, location, 20.0)),
    ...
    KillEffectType(final String name, final String name2, Material material,  int price, final EffectCallable callable) {
        this.name = name;
