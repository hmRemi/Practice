...
public class CC {
    ...
    public static void loadPlugin() {
        ...
        Bukkit.getConsoleSender().sendMessage(translate(" &7| &4Rank System&7: &f" + cPractice.get().getRankManager().getRankSystem()));
        Bukkit.getConsoleSender().sendMessage(translate(" "));
        Bukkit.getConsoleSender().sendMessage(translate(" &7| &4Spigot&7: &f" + cPractice.get().getServer().getName()));
        Bukkit.getConsoleSender().sendMessage(translate(" "));
