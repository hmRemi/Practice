package com.hysteria.practice.utilities.file.type;

import com.google.common.io.Files;
import com.hysteria.practice.HyPractice;
import com.hysteria.practice.utilities.file.AbstractConfigurationFile;
...
public class BasicConfigurationFile extends AbstractConfigurationFile {
    ...
    public void reload() {
        File file = new File(HyPractice.get().getDataFolder(), getName() + ".yml");
        try {
    ...
    public void save() {
        File folder = HyPractice.get().getDataFolder();
        try {
