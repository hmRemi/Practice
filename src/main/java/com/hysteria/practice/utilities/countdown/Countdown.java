package com.hysteria.practice.utilities.countdown;

import com.hysteria.practice.HyPractice;
import com.hysteria.practice.utilities.TimeUtils;
...
public class Countdown implements Runnable {
    ...
    Countdown(int seconds, String broadcastMessage, Runnable tickHandler, Runnable broadcastHandler, Runnable finishHandler, Predicate<Player> messageFilter, List<Player> playerList, int... broadcastAt) {
        ...
        this.assignedTaskId = Bukkit.getScheduler().scheduleSyncRepeatingTask(HyPractice.get(), this, 0L, 20L);
    }
