...
public class GameModeCommand extends BaseCommand {
	...
	@Command(name = "gamemode", aliases = {"gm"}, permission = "hypractice.command.gamemode")
	@Override
	public void onCommand(CommandArgs commandArgs) {
		...
		if (profile.getState() == ProfileState.FIGHTING || profile.getState() == ProfileState.FFA) {
			player.sendMessage(CC.translate("&4You cannot execute this command while fighting."));
			return;
		}
