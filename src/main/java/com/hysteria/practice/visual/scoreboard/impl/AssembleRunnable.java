package com.hysteria.practice.visual.scoreboard.impl;
...
public class AssembleRunnable implements Runnable {
     ...
     */
    AssembleRunnable(Assemble assemble) {
        this.assemble = assemble;
        HyPractice.get().getServer().getScheduler().runTaskTimerAsynchronously(HyPractice.get(), this, 20L, 2L);
    }
