...
public class KitGameRules {
	...
	private boolean build, spleef, sumo, parkour, healthRegeneration, ranked, showHealth, hcf, lives, bridge, boxing, nofalldamage, soup, antiFood, bedFight, hcftrap, battlerush;
