package com.hysteria.practice.player.profile.menu.matchmaking;
...
public class PingRangeButton extends Button {
    ...
    public ItemStack getButtonItem(Player player) {
        ...
        arrayList.add(CC.translate("&7Ping Range: &4" + (profile.getPingRange() == -1 ? "Unrestricted" : Integer.valueOf(profile.getPingRange()))));
