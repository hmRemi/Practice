...
public class Clan {
    ...
    public List<String> getClanScoreboard() {
        ...
        config.getStringList("CLAN.LINES").forEach(line -> lines.add(line.replace("{bars}", bars)
    ...
    public void sendChat(Player player, String message) {
        sendMessage(Locale.CLAN_CHAT_REFIX.format(Profile.get(player.getUniqueId()).getLocale()) + Clan.getByPlayer(player).getColoredName() + " " + player.getDisplayName() + ChatColor.RESET + ": " + message);
    }
