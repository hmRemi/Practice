package com.hysteria.practice.player.cosmetics.impl.trails;
...
{
    ANGRY("Angry", "ANGRY", Material.RED_ROSE, location -> ParticleEffect.VILLAGER_ANGRY.display(0.5f, 0.5f, 0.5f, 0.01f, 25, location, 20.0)),
    ...
    CLOUD("Cloud", "CLOUD", Material.WOOL, location -> ParticleEffect.CLOUD.display(0.0f, 0.0f, 0.0f, 0.1f, 100, location, 20.0)),
    ...
    COOKIE("Cookie", "COOKIE", Material.COOKIE, location -> ParticleEffect.ITEM_CRACK.display(new ParticleEffect.ItemData(Material.COOKIE, (byte)0), 0.7f, 0.7f, 0.7f, 0.1f, 35, location, 20.0)),
    ...
    TNT("TNT", "TNT", Material.TNT, location -> ParticleEffect.EXPLOSION_LARGE.display(0.5f, 0.5f, 0.5f, 1.0f, 12, location, 20.0)),
    ...
    FLAME("Flame", "FLAME", Material.FLINT_AND_STEEL, location -> ParticleEffect.FLAME.display(0.2f, 0.2f, 0.2f, 0.1f, 10, location, 20.0)),
    ...
    HAPPY("Happy", "HAPPY", Material.EMERALD_ORE, location -> ParticleEffect.VILLAGER_HAPPY.display(0.5f, 0.5f, 0.5f, 0.01f, 100, location, 20.0)),
    HEART("Heart", "HEART", Material.REDSTONE_BLOCK, location -> ParticleEffect.HEART.display(0.4f, 0.4f, 0.4f, 0.1f, 10, location, 20.0)),
    ...
    LAVA("Lava", "LAVA", Material.LAVA_BUCKET, location -> ParticleEffect.LAVA.display(0.5f, 0.5f, 0.5f, 0.1f, 12, location, 20.0)),
    LIGHTING("Lighting", "LIGHTNING", Material.STICK, location -> location.getWorld().strikeLightningEffect(location)),
    NOTE("Note", "NOTE", Material.NOTE_BLOCK, location -> ParticleEffect.NOTE.display(0.5f, 0.5f, 0.5f, 1.0f, 12, location, 20.0)),
    ...
    }.runTaskTimerAsynchronously(HyPractice.get(), 0L, 1L));
    ...
    TrailsEffectType(final String name, final String name2, Material material, final EffectCallable callable) {
        this.name = name;
