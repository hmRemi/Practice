package com.hysteria.practice.player.cosmetics.impl.trails.menu;
...
public class TrailsEffectsMenu extends PaginatedMenu
{
    ...
    @Override
    public Map<Integer, com.hysteria.practice.utilities.menu.Button> getAllPagesButtons(final Player player) {
        final Map<Integer, com.hysteria.practice.utilities.menu.Button> buttons = new HashMap<>();
    ...
    {
        private final TrailsEffectType type;
