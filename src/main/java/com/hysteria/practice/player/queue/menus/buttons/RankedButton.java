...
public class RankedButton extends Button {
    ...
    public ItemStack getButtonItem(Player player) {
        ...
        return new ItemBuilder(Material.valueOf(HyPractice.get().getMenuConfig().getString("QUEUES.TYPES.RANKED.ICON"))).lore(CC.translate(lore)).amount(1).name(CC.translate(HyPractice.get().getMenuConfig().getString("QUEUES.TYPES.RANKED.NAME"))).durability(HyPractice.get().getMenuConfig().getInteger("QUEUES.TYPES.RANKED.DATA")).build();
    }
