...
public class MatchList extends PaginatedMenu {
    ...
    public String getPrePaginatedTitle(Player player) {
        return CC.translate(HyPractice.get().getMenuConfig().getString("MATCH-LIST.TITLE").replace("{amount}", String.valueOf(Match.getMatches().size())));
    }
    ...
    public static class MatchButton extends Button {
        ...
        public ItemStack getButtonItem(Player player) {
            List<String> lore = HyPractice.get().getMenuConfig().getStringList("MATCH-LIST.LORE");
            lore.replaceAll(s ->
                    CC.translate(s
            ...
            if(match instanceof BasicTeamMatch) {
                return new ItemBuilder(match.getKit().getDisplayIcon().clone())
                    .name(CC.translate(HyPractice.get().getMenuConfig().getString("MATCH-LIST.NAME")
