...
public abstract class Match {
	...
	private final com.hysteria.practice.player.queue.Queue queue;
	 ...
	 *
	 * @param queue {@link com.hysteria.practice.player.queue.Queue} if match is started from queue, then we provide it
