...
public enum Locale {
	...
	PARTY_HOST_CLICKABLE("PARTY.CLICKABLE"),
	...
	MATCH_START_TITLE("MATCH.START_TITLE"),
	MATCH_START_SUBTITLE("MATCH_START_SUBTITLE"),
	...
	REMATCH_RECEIVED_CLICKABLE("REMATCH.RECEIVED_CLICKABLE"),
	...
	EVENT_JOIN_CLICKABLE("EVENT.JOIN_CLICKABLE"),
	...
	FFA_JOIN_MESSAGES("FFA.JOIN_MESSAGE"),
	FFA_REFILL_COOLDOWN("FFA.REFILL_COOLDOWN"),
	FFA_REFILL_COOLDOWN_EXPIRED("FFA.REFILL_COOLDOWN_EXPIRED"),
	...
	public Object format(Lang locale) {
		if (HyPractice.get().getLang().get(path, locale) instanceof List)
			return HyPractice.get().getLang().getStringList(path, locale);
		return HyPractice.get().getLang().getString(path, locale);
	}
